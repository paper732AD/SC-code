...
struct raft_req_tag_t {
  erpc::Serializer req_msgbuf; // 要把下面req中的内容序列化到Serializer中
  void *resp_msgbuf;
  erpc::Buffer req; /* app_appendentries_t */
...
class AppContext {
 public:
  ...
  struct {
    ...
    erpc::Serializer req_msgbuf;   // Preallocated req msgbuf
    void* resp_msgbuf;  // Preallocated response msgbuf
