...
echo "total_phy_bytes of tx and rx is ${total_bytes_send}"
echo "total_phy_bytes of tx and rx is ${total_bytes_send}" >> record1.log
...
if [ "${type}" == "1" ];
then 
    mv record0.log ./log/zrpc_sick_8/"record_detail_${size}_8.txt"
    mv record_detail0.log ./log/zrpc_sick_8/"record_detail_${size}_8_detail.txt"
else
    mv record0.log ./log/zrpc_sick_8/"record_detail_${size}.txt"
    mv record_detail0.log ./log/zrpc_sick_8/"record_detail_${size}_detail.txt"    
fi
#client  
#sudo bash ./eRPC-tests/multi_process.sh client 8 102400 10000
#sudo bash execute_multi.sh 'sudo bash ./test_xrpc/multi_process.sh client 12 1024000 10000' 1 1024000
