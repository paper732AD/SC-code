...
static constexpr size_t kReqNumBits = 32;   ///< Bits for request number
...
// static_assert(sizeof(pkthdr_t) == kHeadroom + 28, "");
// static_assert(sizeof(pkthdr_t) % sizeof(size_t) == 4, "");
