...
struct ChunkOptionsPB : public RPC::Message {
		int32_t FTTType;
		MirrorArgsPB Mirror;
...
struct ReplicaLocationPB : public RPC::Message {
...
struct AccelerateOpenOptionsPB : public RPC::Message {
        ...
        void serialize_fields(AR& ar){
			...
			for(auto rep : ChunkLocation)
				rep.serialize_fields(ar);
		}
};
