...
class Transport {
 public:
  static constexpr size_t kNumRxRingEntries = 16384*2;
  ...
  struct tx_burst_item_t {
    ...
    Serializer* msg_buffer_;         ///< MsgBuffer for this packet
   ...
   */
  void init_hugepage_structures(HugeAlloc* huge_alloc, uint8_t** rx_ring[2]);
